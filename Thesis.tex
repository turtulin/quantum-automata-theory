...
\title{Towards a Unified Taxonomy and Circuit Compilation Framework for Quantum Finite Automata}
...
\author{Marta Musso}
\advisor{Michele Loreti\\Marcello Bonsangue}
%\coadvisor2{}
...
\input{QuantumFiniteAutomata/Main.tex}
\input{AutomataToCircuits/Main.tex}
