\subsection{One-Way Quantum Automata Models}
\label{sec:one-way-qfas}

\glspl{1qfa} process the input tape in a single left-to-right pass. In this section, we review the most relevant models of \glspl{1qfa} and their respective language recognition capabilities. We begin with the standard \glsentryfull{moqfa} and \glsentryfull{mmqfa} models, followed by the \gls{lqfa}, \glsentryfull{1qfac}, \gls{cl-1qfa}, \glsentryfull{a-qfa}, and \gls{mlqfa} models. A detailed comparison of these models is provided, highlighting their relative expressive power and computational efficiency.

\subsubsection{\glsentrylong{moqfa}}
\label{subsec:moqfa}
\begin{definition}[\glsentrylong{moqfa}]
...
\subsubsection{\glsentrylong{mmqfa}}
\label{subsec:mmqfa}
\begin{definition}[\glsentrylong{mmqfa}]
...
\subsubsection{\glsentrylong{lqfa}}
\label{subsec:lqfa}
...
\subsubsection{\glsentrylong{1qfac}}
\label{subsec:1qfac}
...
\subsubsection{\glsentrylong{cl-1qfa}}
...
\subsubsection{\glsentrylong{a-qfa}}
\label{subsec:a-qfa}
...
\subsubsection{\glsentrylong{mlqfa}}
\label{subsec:ml-qfa}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[node distance=1.5cm]
        \node (MO1QFA) {\gls{moqfa}};
        \node (MM1QFA) [above=of MO1QFA] {\gls{mmqfa}};
...
\subsubsection*{Comparison to Classical Finite Automata}
...
%TODO: change occurrencies of regular languages to \gls{regs}
