...
This thesis systematically analysed \glsentrylongpl{qfa} by comparing them to classical models. The goal was to clarify where quantum advantages exist, quantify their costs, and identify practical limitations.

Three key results emerged. First, \glsentrylongpl{1qfa} such as %TODO: check if this is correct, do mm-1qfa recognise regular languages?
